...
class Navigation extends Component {
  ...
  render() {
    const { navigation, navActions } = this.props;
    return (
      <View style={{ flex: 1 }}>
        <AppNavigator
          navigation={addNavigationHelpers({
            state: navigation,
            backBySteps: navActions.backBySteps,
            backWithParams: navActions.backWithParams,
            reset: navActions.reset,
            resetToHome: navActions.resetToHome,
            resetWithHome: navActions.resetWithHome,
